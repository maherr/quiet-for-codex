...
#[derive(Debug, Parser)]
#[command(bin_name = "codex-quiet plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-quiet plugin add",
    after_help = "Examples:\n  codex-quiet plugin add sample@debug\n  codex-quiet plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-quiet plugin list",
    after_help = "Examples:\n  codex-quiet plugin list\n  codex-quiet plugin list --marketplace debug\n  codex-quiet plugin list --json\n  codex-quiet plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-quiet plugin remove",
    after_help = "Examples:\n  codex-quiet plugin remove sample@debug\n  codex-quiet plugin remove sample --marketplace debug"
)]
