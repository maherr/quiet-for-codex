...
#[derive(Debug, Parser)]
#[command(bin_name = "codex-quiet plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-quiet plugin marketplace add",
    after_help = "Examples:\n  codex-quiet plugin marketplace add ./path/to/marketplace\n  codex-quiet plugin marketplace add owner/repo --ref main\n  codex-quiet plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codex-quiet plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-quiet plugin marketplace upgrade",
    after_help = "Examples:\n  codex-quiet plugin marketplace upgrade\n  codex-quiet plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-quiet plugin marketplace remove",
    after_help = "Example:\n  codex-quiet plugin marketplace remove debug"
)]
