...
Quiet for Codex 1.2.2 is based on upstream [`rust-v0.147.0`](https://github.com/openai/codex/releases/tag/rust-v0.147.0). `codex-quiet --version` reports `codex-quiet 1.2.2`; the startup card also identifies the upstream base as `codex 0.147.0`.
...
```shell
curl -fsSL https://raw.githubusercontent.com/maherr/quiet-for-codex/quiet-v1.2.2/scripts/release/install.sh | sh
```

### Windows PowerShell

```powershell
& ([scriptblock]::Create((irm -UseBasicParsing https://raw.githubusercontent.com/maherr/quiet-for-codex/quiet-v1.2.2/scripts/release/install.ps1)))
```
