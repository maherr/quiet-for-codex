...
Quiet for Codex 1.2.3 is based on upstream [`rust-v0.147.0`](https://github.com/openai/codex/releases/tag/rust-v0.147.0). `codex-quiet --version` reports `codex-quiet 1.2.3`; the startup card also identifies the upstream base as `codex 0.147.0`.
